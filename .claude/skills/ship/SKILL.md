...
`--repo sabrahermassi/ai-injury-extractor`.
...
2. Check whether it's already tracked:
   `gh issue list --repo sabrahermassi/ai-injury-extractor --state all --search "<relevant keywords>"`
...
- the remote is `sabrahermassi/ai-injury-extractor`
...
```bash
gh pr create --repo sabrahermassi/ai-injury-extractor --base main --title "<title>" --body "<body>"
```
