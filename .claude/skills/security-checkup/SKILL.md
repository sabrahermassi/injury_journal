...
Given this application handles health/journal data (see `.claude/claude-security-guidance.md`), weigh
data isolation, sensitive data exposure, and privacy/data retention more heavily than you would for a
non-health app — but do not assume every category applies. Focus on risks that are relevant to the
actual application and explain why.
