...
- documentation relevant to the changed area (`docs/lambda-design.md` for Lambda/API changes,
  `docs/dynamodb-design.md` for storage changes) — skip unrelated docs
...
- API contract consistency between `lambda/handler.py` and `frontend/src/lib/api.ts` /
  `frontend/src/lib/injury-schema.ts`
